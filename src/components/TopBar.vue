...
<template>
    <div id="TopBar"
        class="w-[calc(100%-270px)] h-[60px] fixed right-0 z-20 bg-[#101010] bg-opacity-80 flex items-center justify-between">
        ...
        <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
            ...
            <div class="flex items-center">
                <img class="rounded-full" width="30"
                    ...
                    alt="">
                <div class="text-white text-[14px] font-semibold ml-1.5">Rohan Sirohia</div>
